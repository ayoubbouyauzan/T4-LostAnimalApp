...
var app = {
    ...
    initialize: function() {
		...
		*/
		...
		L.tileLayer('Lost My Pet - Map/www/img/mapTiles/{z}/{x}/{y}.png', {
			maxZoom: 17
		}).addTo(map);

		var imageUrl = 'Lost My Pet - Map/www/img/pet/dog1.png',
       imageBounds = [[51.58650, 4.77600], [51.58250, 4.77000]];
        L.imageOverlay(imageUrl, imageBounds).addTo(map);
		
		var imageUrl = 'Lost My Pet - Map/www/img/pet/cat1.png',
       imageBounds = [[51.59650, 4.78600], [51.59250, 4.78000]];
        L.imageOverlay(imageUrl, imageBounds).addTo(map);
		
		var imageUrl = 'Lost My Pet - Map/www/img/pet/horse1.png',
